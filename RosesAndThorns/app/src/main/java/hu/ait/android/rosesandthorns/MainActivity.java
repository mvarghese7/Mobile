...
//    @BindView(R.id.tvNavBarName)
//    TextView tvNavBarName;
...
//        tvNavBarName.setText(FirebaseAuth.getInstance().getCurrentUser().getUid());

        entryAdapter = new EntryRecyclerAdapter(getApplicationContext(),
                FirebaseAuth.getInstance().getCurrentUser().getUid());

        RecyclerView recyclerViewPlaces = (RecyclerView) findViewById(
                R.id.recyclerViewEntries);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);
        layoutManager.setReverseLayout(true);
        layoutManager.setStackFromEnd(true);
        recyclerViewPlaces.setLayoutManager(layoutManager);
        recyclerViewPlaces.setAdapter(entryAdapter);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.my_previous_entries) {
            Intent intent = new Intent(MainActivity.this, MyEntriesActivity.class);
            startActivity(intent);
        } else if (id == R.id.add_new_entry) {
            Intent intent = new Intent(MainActivity.this, NewEntryActivity.class);
            startActivity(intent);
        }
